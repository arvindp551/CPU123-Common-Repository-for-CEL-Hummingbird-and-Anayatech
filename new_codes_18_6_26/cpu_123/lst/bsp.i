...
# 16 "source/Include\\common_header.h"
...
# 17 "source/Include\\common_header.h" 2
...
# 19 "source/Include\\common_header.h" 2
...
# 22 "source/Include\\common_header.h" 2
# 22 "source/bsp.c" 2
# 1 "source/Include\\bsp.h" 1
# 17 "source/Include\\bsp.h"
...
# 18 "source/Include\\bsp.h" 2
# 1 "source/driver/include\\drvr_uart.h" 1
...
# 19 "source/Include\\bsp.h" 2
# 43 "source/Include\\bsp.h"
...
# 24 "source/bsp.c" 2
# 1 "source/Include\\isp_user.h" 1
# 15 "source/Include\\isp_user.h"
# 1 "source/Include\\fmc_user.h" 1
# 12 "source/Include\\fmc_user.h"
# 1 "source/Include\\targetdev.h" 1
# 20 "source/Include\\targetdev.h"
# 1 "source/Include\\isp_user.h" 1
# 21 "source/Include\\targetdev.h" 2
# 13 "source/Include\\fmc_user.h" 2
# 33 "source/Include\\fmc_user.h"
...
# 16 "source/Include\\isp_user.h" 2
# 40 "source/Include\\isp_user.h"
...
static uint8_t buf_rx_cpux[100];
static uint8_t buf_tx_cpux[100];

static fifo_t fifo_rx_cpux;
static fifo_t fifo_tx_cpux;
spi_struct_t spi_cpux = {.todo = 3U, .complete = 1, .state = SPI_IDLE};
...
void bsp_ctor(void) {
 ...
 sysClock_Init();
 fifo_init(&fifo_tx_cpux,buf_tx_cpux,100);
 fifo_init(&fifo_rx_cpux,buf_rx_cpux,100);
 ...
 GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04140UL)),0x00000020UL,0x1UL);
 GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04000UL)),0x00000004UL,0x1UL);




 GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04000UL)),0x00000008UL,0x0UL);

 GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04000UL)),0x00000010UL,0x1UL);
 GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04000UL)),0x00000020UL,0x1UL);
 GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04000UL)),0x00001000UL,0x0UL);

 GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x040C0UL)),0x00000001UL,0x0UL);
 GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x040C0UL)),0x00000002UL,0x0UL);
 GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x040C0UL)),0x00000004UL,0x1UL);

 sysTimer_Init();


 ((CLK_T *) ((0x40000000UL) + 0x00200UL))->AHBCLK |= (0x1ul << (2));
 ((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPCTL |= ((0x1ul << (0)) | (0x1ul << (3)));


 g_apromSize = BL_EnableFMC();
 g_dataFlashAddr = ((SCU_T *) ((0x40000000UL) + 0x2F000UL))->FNSADDR;
...
static void sysTimer_Init(void)
{
 ...
 ((CLK_T *) ((0x40000000UL) + 0x00200UL))->APBCLK0 |= (0x1ul << (5));

 ((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKSEL1 = (((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKSEL1 & (~(0x7ul << (20)))) | (0x7UL<<(20));

 TIMER_Open(((TIMER_T *) ((((0x40000000UL) + 0x00040000UL) + 0x11000UL) + 0x100UL)), (1UL << (27)),1000);

 TIMER_EnableInt(((TIMER_T *) ((((0x40000000UL) + 0x00040000UL) + 0x11000UL) + 0x100UL)));

 TIMER_Start(((TIMER_T *) ((((0x40000000UL) + 0x00040000UL) + 0x11000UL) + 0x100UL)));
...
void TMR3_IRQHandler(void) {
 ...
 TIMER_ClearIntFlag(((TIMER_T *) ((((0x40000000UL) + 0x00040000UL) + 0x11000UL) + 0x100UL)));
 ...
 if((ticks%(1U)) == 0U) {
  if(g_TGT_ticks != 0U) g_TGT_ticks -= 1U;
  if(g_TCF_ticks != 0U) g_TCF_ticks -= 1U;
  if(g_ACKN_D_ticks != 0U) g_ACKN_D_ticks -= 1U;
  if(g_ACKN_R_ticks != 0U) g_ACKN_R_ticks -= 1U;
  if(g_SSBPAC_FAIL_ticks != 0U) g_SSBPAC_FAIL_ticks -= 1U;
 }
 ...
 if((ticks%((1U)*1000U)) == 0U) {
  if(g_120s_ticks != 0U) {g_120s_ticks--;}
 }

 if((ticks%(200U)) == 0U) {
  (*((volatile uint32_t *)((((0x40000000UL) + 0x04800UL)+(0x40*(0))) + ((5)<<2)))) = 1;
 }
 if((ticks%(2000U)) == 0U) {
  (*((volatile uint32_t *)((((0x40000000UL) + 0x04800UL)+(0x40*(0))) + ((5)<<2)))) = 0;
 }
