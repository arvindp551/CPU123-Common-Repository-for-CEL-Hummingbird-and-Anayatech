...
# 51 "C:\\Users\\Anaya\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\string.h" 3
...
static _Bool enable_watchdog = 0;
...
void cpu_sm(void) {
 ...
 switch(cpu_state){
  ...
  case WAIT_READY_STATE:
   ...
   b &= (ctrls_u.x.interlock_mode != 0x00U);
   b &= (ctrls_u.x.oe_state_avl != 0);

   (((WDT_T *) (((0x40000000UL) + 0x00040000UL) + 0x00000UL))->RSTCNT = (0x00005AA5UL));
   if (b) {
  ...
  case OPERATIONAL_STATE:
   ...
   if(ctrls_u.x.enable_hang){
    while(1) {}
   }

   if(onesec_pulse) {
    onesec_pulse = 0;
    (*((volatile uint32_t *)((((0x40000000UL) + 0x04800UL)+(0x40*(5))) + ((5)<<2)))) = ((*((volatile uint32_t *)((((0x40000000UL) + 0x04800UL)+(0x40*(5))) + ((5)<<2)))) != 0U)?0:1;
   }
   break;
  default:
...
static uint8_t get_flash_checksum(void) {
 uint8_t ret = 0;
 static uint32_t flash_addr = 0x00000000UL;
 _Bool b;

 FMC_Open();


 db.flash_cksum = FMC_GetChkSum(0x00000000UL, ((20810U +2047U)/2048U)*2048U);

 b = (g_FMC_i32ErrCode == 0) ? 0 : 1;
 if(b) {
  ret = 1;
 }
 else {
...
void cpu_fpga_xfer(void) {
 ...
 _Bool clk_rising;
 _Bool clk_falling;
 uint8_t clk_now = (*((volatile uint32_t *)((((0x40000000UL) + 0x04800UL)+(0x40*(3))) + ((0)<<2))));
 uint8_t rst = (*((volatile uint32_t *)((((0x40000000UL) + 0x04800UL)+(0x40*(3))) + ((1)<<2))));
 ...
 if(rst == 0U) {
  st_i = 0;
  (*((volatile uint32_t *)((((0x40000000UL) + 0x04800UL)+(0x40*(3))) + ((2)<<2)))) = 1;
  sm_state = 0;
  st_k = 0;
  sm_state_1 = 0;
  i_1 = 0;
  ...
  switch(sm_state) {
   case 0:
    ...
    (*((volatile uint32_t *)((((0x40000000UL) + 0x04800UL)+(0x40*(3))) + ((2)<<2)))) = v;
    st_i++;
    if(st_i==8U) {
     st_i = 0;
     st_k++;
  ...
  switch(sm_state_1) {
   ...
   case 0:
    data_1 >>= 1U;
    data_1 &= (~(uint8_t)0x80);
    data_1 |= (((*((volatile uint32_t *)((((0x40000000UL) + 0x04800UL)+(0x40*(3))) + ((3)<<2)))) << 7U) & 0x80U);
    i_1++;
    if(i_1==8U) {
     i_1 = 0;
     db.oe_vi[k_1] = data_1;
   ...
   case 2:
    data_1 >>= 1U;
    data_1 &= (~(uint8_t)0x80);
    data_1 |= (uint8_t)(((*((volatile uint32_t *)((((0x40000000UL) + 0x04800UL)+(0x40*(3))) + ((3)<<2)))) << 7U) & 0x80U);
    i_1++;
    if(i_1==8U) {
     i_1 = 0;
     db.oe_lo[k_1] = data_1;
...
void vi_process(void) {
 ...
 switch (lstate) {
  case 0:
   ...
   (*((volatile uint32_t *)((((0x40000000UL) + 0x04800UL)+(0x40*(0))) + ((4)<<2)))) = 0;
   break;
  case 1:
   (*((volatile uint32_t *)((((0x40000000UL) + 0x04800UL)+(0x40*(0))) + ((4)<<2)))) = 1;
   lstate = 2;
   break;
  case 2:
   relayidx = 0;
   ...
   break;
  case 3:
   (*((volatile uint32_t *)((((0x40000000UL) + 0x04800UL)+(0x40*(0))) + ((2)<<2)))) = 1;
   lstate = 4;
   break;
  case 4:

   (*((volatile uint32_t *)((((0x40000000UL) + 0x04800UL)+(0x40*(0))) + ((2)<<2)))) = 0;
   i = (relayidx/2U);
   d = (*((volatile uint32_t *)((((0x40000000UL) + 0x04800UL)+(0x40*(0))) + ((3)<<2))));
   ...
   if((relayidx%2U) == 1U) {
    ...
    if(db.vi_pair[i].state_on_change != db.vi_pair[i].state_now) {
     db.vi_pair[i].dbounce_ticks = 2U;
     db.vi_pair[i].state_on_change = db.vi_pair[i].state_now;
     db.vi_pair[i].unstable_check_count++;
     if(db.vi_pair[i].unstable_check_count > 2U) {
      db.vi_is_unstable[byteidx] &= (~((uint8_t)0x03U << bitidx));
      db.vi_is_unstable[byteidx] |= ((uint8_t)0x03U << bitidx);
     }
    }
 ...
 while(!frx->is_empty) {
  ...
  if(ch == 0xA1U) {
   ...
   if(reg == 0x00U) {
    ...
    if ((ch%2U) == 0U) {
     i = db.vi_pair[ch/2U].mask & 0x01U;
    }
    else {
     i = db.vi_pair[ch/2U].mask & 0x02U;
    }
    ch = (i!=0U) ? 1U : 0U;
    fifo_write(ftx,ch);
    chksum = ch;
   ...
   if(ch == 0x00U) {
    ...
    if ((ch%2U) == 0U) {
     db.vi_pair[ch/2U].mask &= (~(uint8_t)0x01U);
     db.vi_pair[ch/2U].mask |= (uint8_t)((i!=0U)?0x01U:0x00U);
    }
    else {
     db.vi_pair[ch/2U].mask &= (~(uint8_t)0x2U);
     db.vi_pair[ch/2U].mask |= (uint8_t)((i!=0U)?0x02U:0x00U);
    }
    fifo_write(ftx,0xAA);
    chksum = 0xAA;
    fifo_write(ftx,chksum);
