# 1 "../../CCC_common/Library/StdDriver/src/sys.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 402 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../CCC_common/Library/StdDriver/src/sys.c" 2
# 11 "../../CCC_common/Library/StdDriver/src/sys.c"
...
# 12 "../../CCC_common/Library/StdDriver/src/sys.c" 2
# 39 "../../CCC_common/Library/StdDriver/src/sys.c"
void SYS_ClearResetSrc(uint32_t u32Src)
{
    ((SYS_T *) ((0x40000000UL) + 0x00000UL))->RSTSTS = u32Src;
}
# 51 "../../CCC_common/Library/StdDriver/src/sys.c"
uint32_t SYS_GetBODStatus(void)
{
...
# 74 "../../CCC_common/Library/StdDriver/src/sys.c"
uint32_t SYS_IsRegLocked(void)
{
...
# 97 "../../CCC_common/Library/StdDriver/src/sys.c"
void SYS_ResetChip(void)
{
    ((SYS_T *) ((0x40000000UL) + 0x00000UL))->IPRST0 |= (0x1ul << (0));
}
# 109 "../../CCC_common/Library/StdDriver/src/sys.c"
void SYS_ResetCPU(void)
{
    ((SYS_T *) ((0x40000000UL) + 0x00000UL))->IPRST0 |= (0x1ul << (1));
}
# 168 "../../CCC_common/Library/StdDriver/src/sys.c"
void SYS_ResetModule(uint32_t u32ModuleIndex)
{
...
# 200 "../../CCC_common/Library/StdDriver/src/sys.c"
void SYS_EnableBOD(int32_t i32Mode, uint32_t u32BODLevel)
{
...
# 219 "../../CCC_common/Library/StdDriver/src/sys.c"
void SYS_DisableBOD(void)
{
    ((SYS_T *) ((0x40000000UL) + 0x00000UL))->BODCTL &= ~(0x1ul << (0));
}
# 234 "../../CCC_common/Library/StdDriver/src/sys.c"
void SYS_SetPowerLevel(uint32_t u32PowerLevel)
{

    ((SYS_T *) ((0x40000000UL) + 0x00000UL))->PLCTL = (((SYS_T *) ((0x40000000UL) + 0x00000UL))->PLCTL & (~(0x3ul << (0)))) | (u32PowerLevel);
}
# 252 "../../CCC_common/Library/StdDriver/src/sys.c"
uint32_t SYS_SetPowerRegulator(uint32_t u32PowerRegulator)
{
...
# 326 "../../CCC_common/Library/StdDriver/src/sys.c"
void SYS_SetSSRAMPowerMode(uint32_t u32SRAMSel, uint32_t u32PowerMode)
{
...
# 363 "../../CCC_common/Library/StdDriver/src/sys.c"
void SYS_SetPSRAMPowerMode(uint32_t u32SRAMSel, uint32_t u32PowerMode)
{
...
# 396 "../../CCC_common/Library/StdDriver/src/sys.c"
void SYS_SetVRef(uint32_t u32VRefCTL)
{
