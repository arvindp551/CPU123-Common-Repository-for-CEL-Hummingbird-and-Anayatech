# 1 "../../CCC_common/Library/StdDriver/src/fmc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 402 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../CCC_common/Library/StdDriver/src/fmc.c" 2
# 13 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 14 "../../CCC_common/Library/StdDriver/src/fmc.c" 2
...
# 15 "../../CCC_common/Library/StdDriver/src/fmc.c" 2
# 24 "../../CCC_common/Library/StdDriver/src/fmc.c"
int32_t g_FMC_i32ErrCode = 0;
# 45 "../../CCC_common/Library/StdDriver/src/fmc.c"
uint32_t FMC_CheckAllOne(uint32_t u32addr, uint32_t u32count)
{
    ...
    if(g_FMC_i32ErrCode == 0)
    {
        ...
        while( (((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPDAT == 0UL) && (g_FMC_i32ErrCode == 0) );
    }
    ...
    if( g_FMC_i32ErrCode == 0 )
    {
        if(((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPDAT == 0xA11FFFFFUL)
            ret = 0xA11FFFFFUL;
        else if(((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPDAT == 0xA1100000UL)
            ret = 0xA1100000UL;
        else
            g_FMC_i32ErrCode = -1;
    }
...
# 119 "../../CCC_common/Library/StdDriver/src/fmc.c"
void FMC_Close(void)
{
    ((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPCTL &= ~(0x1ul << (0));
}
# 141 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 252 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 300 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 346 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 393 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 474 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 502 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 567 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 626 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 659 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 713 "../../CCC_common/Library/StdDriver/src/fmc.c"
void FMC_Open(void)
{
    ((FMC_T *) ((0x40000000UL) + 0x0C000UL))->ISPCTL |= (0x1ul << (0));
}
# 733 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 772 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 826 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 889 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 918 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 947 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 1026 "../../CCC_common/Library/StdDriver/src/fmc.c"
                      ...
                      const int32_t i32LockCONFIG, const int32_t i32LockSPROM)
{
    ...
    if(FMC_Erase(0x00311000UL + 0x800UL))
    {
        ret = -3;
    }
...
# 1122 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 1162 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 1211 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 1252 "../../CCC_common/Library/StdDriver/src/fmc.c"
...
# 1382 "../../CCC_common/Library/StdDriver/src/fmc.c"
