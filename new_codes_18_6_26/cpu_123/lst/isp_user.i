...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "source/isp_user.c" 2
# 10 "source/isp_user.c"
...
# 20 "source/Include\\targetdev.h" 2
# 1 "source/Include\\isp_user.h" 1
...
# 13 "source/isp_user.c" 2

__attribute__((aligned(4))) uint8_t response_buff[64];
__attribute__((aligned(4))) static uint8_t aprom_buf[0x800UL];
...
int ParseCmd(unsigned char *buffer, uint8_t len)
{
    ...
    {
        (*((volatile unsigned int *)(response + 8))=(((SYS_T *) ((0x40000000UL) + 0x00000UL))->PDID));
        goto out;
    }
    else if(lcmd == 0x000000AB)
    {
    ...
    {
        g_packno = 1;
        (*((volatile unsigned int *)(response + 8))=(g_apromSize));
        (*((volatile unsigned int *)(response + 12))=(g_dataFlashAddr));
        goto out;
    }
    else if(lcmd == 0x000000A3)
    {
    ...
    if((lcmd == 0x000000A0) || (lcmd == 0x000000C3))
    {
        ...
        {
            StartAddress = ((*((volatile unsigned int *)(pSrc))));
    ...
    else if(lcmd == 0x000000FF)
    {
        ...
        PageAddress = StartAddress & (0x100000 - 0x800UL);
        ...
        if((StartAddress % 0x800UL) >= (0x800UL - LastDataLen))
        {
            FMC_Erase_User(PageAddress + 0x800UL);
        }
