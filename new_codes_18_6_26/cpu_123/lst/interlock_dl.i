# 1 "source/interlock_DL.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 402 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "source/interlock_DL.c" 2
# 20 "source/interlock_DL.c"
...
void interlock_DL(void) {
 ...
 switch(lstate_DL) {
  ...
  case 1:
   ...
   break;
  case 2:
   TGTR_1 = ((vi->AZTR_D==2U) && (vi->ASGNCR==2U) && (vi->TGTN==2U) && (vi->BPN==2U) && (lo_in->TGTYR==2U) && (lo_in->TGTXR==2U) && (vi->SM_KEY==2U))?2U:1U;
   TGTR_2 = ((vi->AZTR_D==2U) && (vi->ASGNCR==2U) && (vi->TGTN==1U) && (vi->BPN==1U) && (lo_in->TGTZR==1U) && (lo_in->TGTYR==1U))?2U:1U;
   TGTR_3 = 1U;

   TCFR_1 = ((vi->AZTR_R==2U) && (vi->HSGNCR==2U) && (vi->HSBTPR==2U) && (vi->BPN==1U) && (vi->CNR==1U) && (lo_in->TCFXR==2U) && (lo_in->BTSR==2U) && (lo_in->CAR==1U) && (lo_in->ASGNCPR==2U) && (lo_in->JPR120==1U) && (lo_in->TAR1==1U) && (lo_in->TAR2==1U) && (vi->LCB_KEY==2U))?2U:1U;
   TCFR_2 = ((vi->AZTR_R==2U) && (vi->HSGNCR==2U) && (vi->CNR==1U) && (lo_in->TCFXR==1U) && (lo_in->CAR==2U) && (lo_in->ASGNCPR==2U) && (lo_in->JPR120==2U))?2U:1U;
   TCFR_3 = ((vi->AZTR_R==2U) && (vi->HSGNCR==2U) && (vi->CNR==1U) && (lo_in->TCFXR==1U) && (lo_in->CAR==1U) && (lo_in->ASGNCPR==2U) && (lo_in->TAR2==2U))?2U:1U;

   ASCR_1 = ((vi->AZTR_D==2U) && (vi->TGTR_FDBK==2U) && (vo_in->TGTR==2U) && (lo_in->TGTYR==2U))?2U:1U;
   ASCR_2 = ((vi->AZTR_D==2U) && (vi->TGTR_FDBK==2U) && (vi->ASCR ==2U) && (vo_in->TGTR==2U))?2U:1U;

   lo->TGTXR = ((vi->AZTR_D==2U) && (vi->ASGNCR==2U) && (vi->TGTN==2U) && (vi->BPN==2U) && (vo_in->TGTR==1U) && (vi->SM_KEY==2U))?2U:1U;
   lo->TGTYR = ((vo_oe->TCFR==2U) && (lo_oe->BTSR==2U) && (vi->SM_KEY==2U))?2U:1U;
   lo->TGTZR = ((vo_oe->TCFR==2U) && (vi_oe->HSGNCR==2U))?2U:1U;
   lo->TCFXR = ((lo_oe->TGTXR==2U))?2U:1U;
   lo->ASGNCPR = ((vi_oe->ASGNCR==2U))?2U:1U;
   x = ((vi->AZTR_R==2U) && (vi->HSGNCR==2U) && (vi->BPN==2U) && (vi->CNR==2U) && (lo_in->ASGNCPR==2U) && (lo_in->TCFCR==2U) && (vo_in->TCFR==2U) && (vi->SM_KEY==2U));
   x = x || ((vi->AZTR_R==2U) && (lo_in->CAR==2U) && (vo_in->TCFR==2U));
   lo->CAR = x?2U:1U;
   x = ((vi->AZTR_R==2U) && (lo_in->CAR==1U) && (vo_in->TCFR==1U));
   x = x || ((vi->AZTR_R==2U) && (lo_in->BTSR==2U) && (lo_in->CAR==1U));
   lo->BTSR = x?2U:1U;
   x = ((vi->AZTR_R==2U) && (lo_in->BTSR==1U) && (lo_in->FR2==1U) && (vo_in->TCFR==2U));
   x = x || ((vi->AZTR_D==2U) && (lo_in->TGTYR==1U) && (lo_in->FR2==1U) && (vo_in->TGTR==2U));
   lo->FR1 = x?2U:1U;
   x = ((vi->AZTR_R==2U) && (lo_in->BTSR==1U) && (lo_in->FR1==2U) && (vo_in->TCFR==2U));
   x = x || ((vi->AZTR_D==2U) && (lo_in->TGTYR==1U) && (lo_in->FR1==2U) && (vo_in->TGTR==2U));
   lo->FR2 = x?2U:1U;
   ...
   lo->JPR120 = ((g_120s_ticks <= 10U) && (g_120s_ticks > 0U))?2U:1U;
   if(g_tcf_120jpr_state == 2U) {g_tcf_120jpr_state = 0;}
   else {g_tcf_120jpr_state = g_tcf_120jpr_state;}

   lo->TCFZR = ((vo_in->TCFR==1U))?2U:1U;
   lo->TCFCR = ((vi_oe->ASGNCR==2U))?2U:1U;
   lo->TGTPR = ((vo_in->TGTR==1U))?2U:1U;

   nvo->CAN_CNTR = (lo_in->CAR==2U)?1:0;
   nvo->TGT_R_TOL = ((vi->AZTR_D==1U) && (vo_in->TGTR==2U))?1:0;
   nvo->TGT_RA = ((vi->AZTR_D==1U) && (vo_in->TGTR==2U))?1:0;
   nvo->TCF_R_TOL = ((vi->AZTR_R==1U) && (vo_in->TCFR==2U))?1:0;
   nvo->TCF_RA = ((vi->AZTR_R==1U) && (vo_in->TCFR==2U))?1:0;

   nvo->SMKEY = (vi->SM_KEY==2U)?1:0;
   nvo->SNOEK = (vo_oe->ASCR==1U)?1:0;
   nvo->SNK = (vi->ASCR ==1U)?1:0;
   nvo->LC = ((vi->AZTR_D==2U) && (vi->ASGNCR==2U) && (vi_oe->HSGNCR==2U) && (vi_oe->HSATPR==2U) && (vi_oe->HSBTPR==2U) && (vi->ASCR ==1U) && (vo_oe->TCFR==1U) && (vo_in->TGTR==1U))?1:0;
   nvo->SHK_G = ((vi->EKT_KEY==2U) && (vi->SM_KEY==1U))?1:0;
   nvo->SHK_R = (vi->SM_KEY==2U)?1:0;

   nvo->RESET_CNTR = (vi->RST_BTN==2U)?1:0;
   nvo->LSS_R = ((vi->ASCR ==1U)?1:0);
   nvo->LSS_G = ((vi->ASCR ==2U)?1:0);
   nvo->LINE_F = ((vi->AZTR_D==2U)?1:0);
   nvo->LINE_O = ((vi->AZTR_D==1U)?1:0);
   nvo->BELL = ((vi_oe->BPN==2U) && (vi_oe->SM_KEY==2U))?1:0;
   nvo->LC_DL = ((vi->AZTR_R==2U) && (vi_oe->ASGNCR==2U) && (vi->HSGNCR==2U) && (vi->HSATPR==2U) && (vi->HSBTPR==2U) && (vi_oe->ASCR ==1U) && (vo_in->TCFR==1U) && (vo_oe->TGTR==1U))?1:0;

   nvo->LINE_TCF_F = (vi->AZTR_R == 2U)?1:0;
   nvo->LINE_TCF_O = (vi->AZTR_R == 1U)?1:0;

   nvo->SNK_R = ((vi->HSGNCR == 2U) && (vi_oe->ASCR == 1U))?1:0;
  ...
  switch (lstate_TGT_SM_DL)
  {
   ...
   case 3:
    if((vo_in->TGTR == 2U) && (vi->AZTR_D == 2U)) {
     ...
     nvo->LINE_STATUS_TGT = 2;
    }
    else if((vo_in->TGTR == 1U) && (vi->AZTR_D == 2U)) {
     lstate_TGT_SM_DL = 4;
    }
    else {
...
void interlock_TCF_SM_DL(void) {
 ...
 switch (lstate_TCF_SM_DL)
 {
  ...
  case 2:
   ...
   if((vi_oe->CNL_COOP == 2U) && (cancel_req != 0U)) {
    g_120s_ticks = 120;
    cancel_req = 0;
    lstate_TCF_SM_DL = 0;
   }
...
void interlock_Buzzer_SM_TGT_DL(void) {
 ...
 if((vi->ACKN_TGT == 2U) && (g_ACKN_D_ticks == 0U)) {
  nvo->ACKN_D = 0;
...
void interlock_Buzzer_SM_TCF_DL(void) {
 ...
 if((vi->TCFR_FDBK == 2U) && (g_ACKN_R_ticks == 0U)) {
  nvo->ACKN_R = 0;
