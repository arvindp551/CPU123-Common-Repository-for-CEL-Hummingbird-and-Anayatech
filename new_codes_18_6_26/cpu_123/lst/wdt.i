# 1 "../../CCC_common/Library/StdDriver/src/wdt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 402 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../CCC_common/Library/StdDriver/src/wdt.c" 2
# 10 "../../CCC_common/Library/StdDriver/src/wdt.c"
...
# 11 "../../CCC_common/Library/StdDriver/src/wdt.c" 2
# 51 "../../CCC_common/Library/StdDriver/src/wdt.c"
void WDT_Open(uint32_t u32TimeoutInterval,
              uint32_t u32ResetDelay,
              uint32_t u32EnableReset,
              uint32_t u32EnableWakeup)
{
    ((WDT_T *) (((0x40000000UL) + 0x00040000UL) + 0x00000UL))->ALTCTL = u32ResetDelay;

    ((WDT_T *) (((0x40000000UL) + 0x00040000UL) + 0x00000UL))->CTL = u32TimeoutInterval | (0x1ul << (7)) |
               (u32EnableReset << (1)) |
               (u32EnableWakeup << (4));
}
