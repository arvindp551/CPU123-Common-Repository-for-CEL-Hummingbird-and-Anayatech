# 1 "../../CCC_common/Library/StdDriver/src/uart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 402 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../CCC_common/Library/StdDriver/src/uart.c" 2
# 12 "../../CCC_common/Library/StdDriver/src/uart.c"
...
# 13 "../../CCC_common/Library/StdDriver/src/uart.c" 2
...
# 14 "../../CCC_common/Library/StdDriver/src/uart.c" 2
# 43 "../../CCC_common/Library/StdDriver/src/uart.c"
void UART_ClearIntFlag(UART_T* uart, uint32_t u32InterruptFlag)
{
...
# 88 "../../CCC_common/Library/StdDriver/src/uart.c"
void UART_Close(UART_T* uart)
{
    uart->INTEN = 0ul;
}
# 103 "../../CCC_common/Library/StdDriver/src/uart.c"
void UART_DisableFlowCtrl(UART_T* uart)
{
    uart->INTEN &= ~((0x1ul << (12)) | (0x1ul << (13)));
}
# 129 "../../CCC_common/Library/StdDriver/src/uart.c"
void UART_DisableInt(UART_T* uart, uint32_t u32InterruptFlag)
{
...
# 170 "../../CCC_common/Library/StdDriver/src/uart.c"
void UART_EnableFlowCtrl(UART_T* uart)
{
...
# 203 "../../CCC_common/Library/StdDriver/src/uart.c"
void UART_EnableInt(UART_T* uart, uint32_t u32InterruptFlag)
{
...
# 247 "../../CCC_common/Library/StdDriver/src/uart.c"
void UART_Open(UART_T* uart, uint32_t u32baudrate)
{
...
# 327 "../../CCC_common/Library/StdDriver/src/uart.c"
uint32_t UART_Read(UART_T* uart, uint8_t pu8RxBuf[], uint32_t u32ReadBytes)
{
...
# 389 "../../CCC_common/Library/StdDriver/src/uart.c"
void UART_SetLineConfig(UART_T* uart, uint32_t u32baudrate, uint32_t u32data_width, uint32_t u32parity, uint32_t u32stop_bits)
{
    uint32_t u32UartClkSrcSel, u32UartClkDivNum;
    uint32_t au32ClkTbl[4] = {(12000000UL), 0ul, (32768UL), (12000000UL)};
...
# 462 "../../CCC_common/Library/StdDriver/src/uart.c"
void UART_SetTimeoutCnt(UART_T* uart, uint32_t u32TOC)
{
...
# 485 "../../CCC_common/Library/StdDriver/src/uart.c"
void UART_SelectIrDAMode(UART_T* uart, uint32_t u32Buadrate, uint32_t u32Direction)
{
    uint32_t u32UartClkSrcSel, u32UartClkDivNum;
    uint32_t au32ClkTbl[4] = {(12000000UL), 0ul, (32768UL), (12000000UL)};
...
# 571 "../../CCC_common/Library/StdDriver/src/uart.c"
void UART_SelectRS485Mode(UART_T* uart, uint32_t u32Mode, uint32_t u32Addr)
{
...
# 595 "../../CCC_common/Library/StdDriver/src/uart.c"
void UART_SelectLINMode(UART_T* uart, uint32_t u32Mode, uint32_t u32BreakLength)
{
...
# 617 "../../CCC_common/Library/StdDriver/src/uart.c"
uint32_t UART_Write(UART_T* uart, uint8_t pu8TxBuf[], uint32_t u32WriteBytes)
{
    uint32_t u32Count, u32delayno;
    uint32_t u32Exit = 0ul;
