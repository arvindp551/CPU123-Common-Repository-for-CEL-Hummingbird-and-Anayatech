# 1 "../../CCC_common/Library/StdDriver/src/i2c.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 402 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../CCC_common/Library/StdDriver/src/i2c.c" 2
# 13 "../../CCC_common/Library/StdDriver/src/i2c.c"
...
# 14 "../../CCC_common/Library/StdDriver/src/i2c.c" 2
# 23 "../../CCC_common/Library/StdDriver/src/i2c.c"
int32_t g_I2C_i32ErrCode = 0;
# 42 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint32_t I2C_Open(I2C_T *i2c, uint32_t u32BusClock)
{
    uint32_t u32Div;
    uint32_t u32Pclk;

    if(i2c == ((I2C_T *) (((0x40000000UL) + 0x00040000UL) + 0x41000UL)))
    {
...
# 76 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_Close(I2C_T *i2c)
{
...
# 109 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_ClearTimeoutFlag(I2C_T *i2c)
{
    i2c->TOCTL |= (0x1ul << (0));
}
# 128 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_Trigger(I2C_T *i2c, uint8_t u8Start, uint8_t u8Stop, uint8_t u8Si, uint8_t u8Ack)
{
    uint32_t u32Reg = 0u;
...
# 162 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_DisableInt(I2C_T *i2c)
{
    i2c->CTL0 &= ~(0x1ul << (7));
}
# 177 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_EnableInt(I2C_T *i2c)
{
    i2c->CTL0 |= (0x1ul << (7));
}
# 191 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint32_t I2C_GetBusClockFreq(I2C_T *i2c)
{
...
# 218 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint32_t I2C_SetBusClockFreq(I2C_T *i2c, uint32_t u32BusClock)
{
    uint32_t u32Div;
    uint32_t u32Pclk;
...
# 247 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint32_t I2C_GetIntFlag(I2C_T *i2c)
{
    return ((i2c->CTL0 & (0x1ul << (3))) == (0x1ul << (3)) ? 1ul : 0ul);
}
# 261 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint32_t I2C_GetStatus(I2C_T *i2c)
{
    return (i2c->STATUS0);
}
# 275 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint8_t I2C_GetData(I2C_T *i2c)
{
    return (uint8_t)(i2c->DAT);
}
# 290 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_SetData(I2C_T *i2c, uint8_t u8Data)
{
    i2c->DAT = u8Data;
}
# 309 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_SetSlaveAddr(I2C_T *i2c, uint8_t u8SlaveNo, uint8_t u8SlaveAddr, uint8_t u8GCMode)
{
    switch(u8SlaveNo)
    {
...
# 341 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_SetSlaveAddrMask(I2C_T *i2c, uint8_t u8SlaveNo, uint8_t u8SlaveAddrMask)
{
    switch(u8SlaveNo)
    {
...
# 373 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_EnableTimeout(I2C_T *i2c, uint8_t u8LongTimeout)
{
    if(u8LongTimeout)
    {
...
# 397 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_DisableTimeout(I2C_T *i2c)
{
    i2c->TOCTL &= ~(0x1ul << (2));
}
# 412 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_EnableWakeup(I2C_T *i2c)
{
    i2c->WKCTL |= (0x1ul << (0));
}
# 427 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_DisableWakeup(I2C_T *i2c)
{
    i2c->WKCTL &= ~(0x1ul << (0));
}
# 442 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint32_t I2C_SMBusGetStatus(I2C_T *i2c)
{
    return (i2c->BUSSTS);
}
# 458 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_SMBusClearInterruptFlag(I2C_T *i2c, uint8_t u8SMBusIntFlag)
{
    i2c->BUSSTS = u8SMBusIntFlag;
}
# 474 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_SMBusSetPacketByteCount(I2C_T *i2c, uint32_t u32PktSize)
{
    i2c->PKTSIZE = u32PktSize;
}
# 490 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_SMBusOpen(I2C_T *i2c, uint8_t u8HostDevice)
{
...
# 516 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_SMBusClose(I2C_T *i2c)
{

    i2c->BUSCTL = 0x00U;
}
# 533 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_SMBusPECTxEnable(I2C_T *i2c, uint8_t u8PECTxEn)
{
    i2c->BUSCTL &= ~(0x1ul << (8));
...
# 557 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint8_t I2C_SMBusGetPECValue(I2C_T *i2c)
{
    return (uint8_t)i2c->PKTCRC;
}
# 575 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_SMBusIdleTimeout(I2C_T *i2c, uint32_t u32Us, uint32_t u32Hclk)
{
...
# 607 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_SMBusTimeout(I2C_T *i2c, uint32_t ms, uint32_t u32Pclk)
{
...
# 643 "../../CCC_common/Library/StdDriver/src/i2c.c"
void I2C_SMBusClockLoTimeout(I2C_T *i2c, uint32_t ms, uint32_t u32Pclk)
{
    uint32_t u32Div, u32Pclk_kHz;
...
# 681 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint8_t I2C_WriteByte(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t u8Data)
{
...
# 746 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint32_t I2C_WriteMultiBytes(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t au8Data[], uint32_t u32wLen)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Ctrl = 0u;
...
# 817 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint8_t I2C_WriteByteOneReg(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t u8DataAddr, uint8_t u8Data)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Ctrl = 0u;
    uint32_t u32txLen = 0u, u32TimeOutCount = 0u;
...
# 893 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint32_t I2C_WriteMultiBytesOneReg(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t u8DataAddr, uint8_t au8Data[], uint32_t u32wLen)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Ctrl = 0u;
    uint32_t u32txLen = 0u, u32TimeOutCount = 0u;
...
# 968 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint8_t I2C_WriteByteTwoRegs(I2C_T *i2c, uint8_t u8SlaveAddr, uint16_t u16DataAddr, uint8_t u8Data)
{
...
# 1048 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint32_t I2C_WriteMultiBytesTwoRegs(I2C_T *i2c, uint8_t u8SlaveAddr, uint16_t u16DataAddr, uint8_t au8Data[], uint32_t u32wLen)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Addr = 1u, u8Ctrl = 0u;
    uint32_t u32txLen = 0u, u32TimeOutCount = 0u;
...
# 1123 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint8_t I2C_ReadByte(I2C_T *i2c, uint8_t u8SlaveAddr)
{
...
# 1193 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint32_t I2C_ReadMultiBytes(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t au8Rdata[], uint32_t u32rLen)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Ctrl = 0u;
...
# 1269 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint8_t I2C_ReadByteOneReg(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t u8DataAddr)
{
...
# 1354 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint32_t I2C_ReadMultiBytesOneReg(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t u8DataAddr, uint8_t au8Rdata[], uint32_t u32rLen)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Ctrl = 0u;
    uint32_t u32rxLen = 0u, u32TimeOutCount = 0u;
...
# 1444 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint8_t I2C_ReadByteTwoRegs(I2C_T *i2c, uint8_t u8SlaveAddr, uint16_t u16DataAddr)
{
...
# 1537 "../../CCC_common/Library/StdDriver/src/i2c.c"
uint32_t I2C_ReadMultiBytesTwoRegs(I2C_T *i2c, uint8_t u8SlaveAddr, uint16_t u16DataAddr, uint8_t au8Rdata[], uint32_t u32rLen)
{
    uint8_t u8Xfering = 1u, u8Err = 0u, u8Addr = 1u, u8Ctrl = 0u;
    uint32_t u32rxLen = 0u, u32TimeOutCount = 0u;
