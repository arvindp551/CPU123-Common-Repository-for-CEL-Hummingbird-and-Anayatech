# 1 "../../CCC_common/Library/StdDriver/src/clk.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 402 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../CCC_common/Library/StdDriver/src/clk.c" 2
# 11 "../../CCC_common/Library/StdDriver/src/clk.c"
...
# 12 "../../CCC_common/Library/StdDriver/src/clk.c" 2
# 31 "../../CCC_common/Library/StdDriver/src/clk.c"
void CLK_DisableCKO(void)
{

    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->APBCLK0 &= (~(0x1ul << (6)));
}
# 56 "../../CCC_common/Library/StdDriver/src/clk.c"
void CLK_EnableCKO(uint32_t u32ClkSrc, uint32_t u32ClkDiv, uint32_t u32ClkDivBy1En)
{
...
# 76 "../../CCC_common/Library/StdDriver/src/clk.c"
void CLK_PowerDown(void)
{
...
# 97 "../../CCC_common/Library/StdDriver/src/clk.c"
void CLK_Idle(void)
{
...
# 116 "../../CCC_common/Library/StdDriver/src/clk.c"
uint32_t CLK_GetHXTFreq(void)
{
...
# 140 "../../CCC_common/Library/StdDriver/src/clk.c"
uint32_t CLK_GetLXTFreq(void)
{
    uint32_t u32Freq = 0UL;
...
# 164 "../../CCC_common/Library/StdDriver/src/clk.c"
uint32_t CLK_GetHCLKFreq(void)
{
    SystemCoreClockUpdate();
    return SystemCoreClock;
}
# 177 "../../CCC_common/Library/StdDriver/src/clk.c"
uint32_t CLK_GetPCLK0Freq(void)
{
    SystemCoreClockUpdate();
    return (SystemCoreClock >> ((((CLK_T *) ((0x40000000UL) + 0x00200UL))->PCLKDIV & (0x7ul << (0))) >> (0)));
}
# 190 "../../CCC_common/Library/StdDriver/src/clk.c"
uint32_t CLK_GetPCLK1Freq(void)
{
    SystemCoreClockUpdate();
    return (SystemCoreClock >> ((((CLK_T *) ((0x40000000UL) + 0x00200UL))->PCLKDIV & (0x7ul << (4))) >> (4)));
}
# 203 "../../CCC_common/Library/StdDriver/src/clk.c"
uint32_t CLK_GetCPUFreq(void)
{
...
# 304 "../../CCC_common/Library/StdDriver/src/clk.c"
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
...
# 383 "../../CCC_common/Library/StdDriver/src/clk.c"
void CLK_SetHCLK(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    uint32_t u32HIRCSTB;
...
# 536 "../../CCC_common/Library/StdDriver/src/clk.c"
void CLK_SetModuleClock(uint32_t u32ModuleIdx, uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
...
# 571 "../../CCC_common/Library/StdDriver/src/clk.c"
void CLK_SetSysTickClockSrc(uint32_t u32ClkSrc)
{
    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKSEL0 = (((CLK_T *) ((0x40000000UL) + 0x00200UL))->CLKSEL0 & ~(0x7ul << (3))) | u32ClkSrc;
}
# 588 "../../CCC_common/Library/StdDriver/src/clk.c"
void CLK_EnableXtalRC(uint32_t u32ClkMask)
{
    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->PWRCTL |= u32ClkMask;
}
# 605 "../../CCC_common/Library/StdDriver/src/clk.c"
void CLK_DisableXtalRC(uint32_t u32ClkMask)
{
    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->PWRCTL &= ~u32ClkMask;
}
# 669 "../../CCC_common/Library/StdDriver/src/clk.c"
void CLK_EnableModuleClock(uint32_t u32ModuleIdx)
{
...
# 739 "../../CCC_common/Library/StdDriver/src/clk.c"
void CLK_DisableModuleClock(uint32_t u32ModuleIdx)
{
    uint32_t u32TmpVal = 0UL, u32TmpAddr = 0UL;
...
# 761 "../../CCC_common/Library/StdDriver/src/clk.c"
uint32_t CLK_EnablePLL(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
...
# 902 "../../CCC_common/Library/StdDriver/src/clk.c"
void CLK_DisablePLL(void)
{
    ((CLK_T *) ((0x40000000UL) + 0x00200UL))->PLLCTL |= (0x1ul << (16));
}
# 922 "../../CCC_common/Library/StdDriver/src/clk.c"
uint32_t CLK_WaitClockReady(uint32_t u32ClkMask)
{
...
# 952 "../../CCC_common/Library/StdDriver/src/clk.c"
void CLK_EnableSysTick(uint32_t u32ClkSrc, uint32_t u32Count)
{
...
# 1076 "../../CCC_common/Library/StdDriver/src/clk.c"
uint32_t CLK_GetPLLClockFreq(void)
{
...
# 1159 "../../CCC_common/Library/StdDriver/src/clk.c"
uint32_t CLK_GetModuleClockSource(uint32_t u32ModuleIdx)
{
    uint32_t u32TmpVal = 0UL, u32TmpAddr = 0UL;
    uint32_t au32SelTbl[4] = {0x0UL, 0x4UL, 0x8UL, 0xCUL};
...
# 1214 "../../CCC_common/Library/StdDriver/src/clk.c"
uint32_t CLK_GetModuleClockDivider(uint32_t u32ModuleIdx)
{
    uint32_t u32TmpVal = 0UL, u32TmpAddr = 0UL;
    uint32_t au32DivTbl[4] = {0x0UL, 0x4UL, 0x8UL, 0x10UL};
