# 1 "../../CCC_common/Library/StdDriver/src/spi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 402 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../CCC_common/Library/StdDriver/src/spi.c" 2
# 10 "../../CCC_common/Library/StdDriver/src/spi.c"
...
# 11 "../../CCC_common/Library/StdDriver/src/spi.c" 2
# 25 "../../CCC_common/Library/StdDriver/src/spi.c"
static uint32_t SPII2S_GetSourceClockFreq(SPI_T *i2s);
# 49 "../../CCC_common/Library/StdDriver/src/spi.c"
                  ...
                  uint32_t u32BusClock)
{
    ...
    if(u32MasterSlave == (0x0UL))
    {
        ...
        if(u32BusClock >= u32HCLKFreq)
        {
            ...
            else if(spi == ((SPI_T *) (((0x40000000UL) + 0x00040000UL) + 0x22000UL)))
            {
...
# 288 "../../CCC_common/Library/StdDriver/src/spi.c"
void SPI_ClearTxFIFO(SPI_T *spi)
{
    spi->FIFOCTL |= (0x1ul << (9));
}
...
# 313 "../../CCC_common/Library/StdDriver/src/spi.c"
void SPI_EnableAutoSS(SPI_T *spi, uint32_t u32SSPinMask, uint32_t u32ActiveLevel)
{
    spi->SSCTL = (spi->SSCTL & (~((0x1ul << (3)) | (0x1ul << (2)) | (0x1ul << (0))))) | (u32SSPinMask | u32ActiveLevel | (0x1ul << (3)));
}
# 332 "../../CCC_common/Library/StdDriver/src/spi.c"
uint32_t SPI_SetBusClock(SPI_T *spi, uint32_t u32BusClock)
{
...
# 489 "../../CCC_common/Library/StdDriver/src/spi.c"
void SPI_SetFIFO(SPI_T *spi, uint32_t u32TxThreshold, uint32_t u32RxThreshold)
{
...
# 612 "../../CCC_common/Library/StdDriver/src/spi.c"
void SPI_EnableInt(SPI_T *spi, uint32_t u32Mask)
{
...
# 695 "../../CCC_common/Library/StdDriver/src/spi.c"
void SPI_DisableInt(SPI_T *spi, uint32_t u32Mask)
{
...
# 778 "../../CCC_common/Library/StdDriver/src/spi.c"
uint32_t SPI_GetIntFlag(SPI_T *spi, uint32_t u32Mask)
{
...
# 866 "../../CCC_common/Library/StdDriver/src/spi.c"
void SPI_ClearIntFlag(SPI_T *spi, uint32_t u32Mask)
{
    if(u32Mask & (0x001UL))
    {
...
# 927 "../../CCC_common/Library/StdDriver/src/spi.c"
uint32_t SPI_GetStatus(SPI_T *spi, uint32_t u32Mask)
{
...
# 992 "../../CCC_common/Library/StdDriver/src/spi.c"
static uint32_t SPII2S_GetSourceClockFreq(SPI_T *i2s)
{
    uint32_t u32Freq;
    ...
    else if(i2s == ((SPI_T *) (((0x40000000UL) + 0x00040000UL) + 0x22000UL)))
    {
        if((CLK_GetModuleClockSource(((((1UL) & 0x03UL) << 30)|((((uint32_t)(14)) & 0x1fUL) << 0) | (((2UL) & 0x03UL) << 28)|(((3UL) & 0x07UL) << 25)|(((6UL) & 0x1fUL) << 20)| (((0x0UL) & 0x03UL) << 18)|(((0x0UL) & 0xffUL) << 10)|(((0x0UL) & 0x1fUL) << 5))) << (6)) == (0x0UL<<(6)))
        {
            u32Freq = (12000000UL);
...
# 1103 "../../CCC_common/Library/StdDriver/src/spi.c"
uint32_t SPII2S_Open(SPI_T *i2s, uint32_t u32MasterSlave, uint32_t u32SampleRate, uint32_t u32WordWidth, uint32_t u32Channels, uint32_t u32DataFormat)
{
    uint32_t u32Divider;
...
# 1234 "../../CCC_common/Library/StdDriver/src/spi.c"
void SPII2S_EnableInt(SPI_T *i2s, uint32_t u32Mask)
{
...
# 1294 "../../CCC_common/Library/StdDriver/src/spi.c"
void SPII2S_DisableInt(SPI_T *i2s, uint32_t u32Mask)
{
...
# 1347 "../../CCC_common/Library/StdDriver/src/spi.c"
uint32_t SPII2S_EnableMCLK(SPI_T *i2s, uint32_t u32BusClock)
{
    uint32_t u32Divider;
...
# 1404 "../../CCC_common/Library/StdDriver/src/spi.c"
void SPII2S_SetFIFO(SPI_T *i2s, uint32_t u32TxThreshold, uint32_t u32RxThreshold)
{
