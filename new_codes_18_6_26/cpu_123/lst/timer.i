# 1 "../../CCC_common/Library/StdDriver/src/timer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 402 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../CCC_common/Library/StdDriver/src/timer.c" 2
# 10 "../../CCC_common/Library/StdDriver/src/timer.c"
...
# 11 "../../CCC_common/Library/StdDriver/src/timer.c" 2
# 43 "../../CCC_common/Library/StdDriver/src/timer.c"
uint32_t TIMER_Open(TIMER_T *timer, uint32_t u32Mode, uint32_t u32Freq)
{
...
# 76 "../../CCC_common/Library/StdDriver/src/timer.c"
void TIMER_Close(TIMER_T *timer)
{
    timer->CTL = 0UL;
    timer->EXTCTL = 0UL;
}
# 95 "../../CCC_common/Library/StdDriver/src/timer.c"
int32_t TIMER_Delay(TIMER_T *timer, uint32_t u32Usec)
{
    uint32_t u32Clk = TIMER_GetModuleClock(timer);
...
# 199 "../../CCC_common/Library/StdDriver/src/timer.c"
void TIMER_EnableCapture(TIMER_T *timer, uint32_t u32CapMode, uint32_t u32Edge)
{
    timer->EXTCTL = (timer->EXTCTL & ~((0x1ul << (4)) | (0x7ul << (12)))) |
                    u32CapMode | u32Edge | (0x1ul << (3));
}
# 214 "../../CCC_common/Library/StdDriver/src/timer.c"
void TIMER_DisableCapture(TIMER_T *timer)
{
    timer->EXTCTL &= ~(0x1ul << (3));
}
# 233 "../../CCC_common/Library/StdDriver/src/timer.c"
void TIMER_EnableEventCounter(TIMER_T *timer, uint32_t u32Edge)
{
    timer->EXTCTL = (timer->EXTCTL & ~(0x1ul << (0))) | u32Edge;
    timer->CTL |= (0x1ul << (24));
}
# 248 "../../CCC_common/Library/StdDriver/src/timer.c"
void TIMER_DisableEventCounter(TIMER_T *timer)
{
    timer->CTL &= ~(0x1ul << (24));
}
# 263 "../../CCC_common/Library/StdDriver/src/timer.c"
uint32_t TIMER_GetModuleClock(TIMER_T *timer)
{
    uint32_t u32Src, u32Clk = (12000000UL);
    const uint32_t au32Clk[] = {(12000000UL), (32768UL), 0UL, 0UL, 0UL, (10000UL), 0UL, (12000000UL)};

    if(timer == ((TIMER_T *) (((0x40000000UL) + 0x00040000UL) + 0x10000UL)))
    {
        u32Src = CLK_GetModuleClockSource(((((1UL) & 0x03UL) << 30)|((((uint32_t)(2)) & 0x1fUL) << 0)| (((1UL) & 0x03UL) << 28)|(((7UL) & 0x07UL) << 25)|(((8UL) & 0x1fUL) << 20)| (((0x0UL) & 0x03UL) << 18)|(((0x0UL) & 0xffUL) << 10)|(((0x0UL) & 0x1fUL) << 5)));
    }
    else if(timer == ((TIMER_T *) ((((0x40000000UL) + 0x00040000UL) + 0x10000UL) + 0x100UL)))
    {
        u32Src = CLK_GetModuleClockSource(((((1UL) & 0x03UL) << 30)|((((uint32_t)(3)) & 0x1fUL) << 0) | (((1UL) & 0x03UL) << 28)|(((7UL) & 0x07UL) << 25)|(((12UL) & 0x1fUL) << 20)| (((0x0UL) & 0x03UL) << 18)|(((0x0UL) & 0xffUL) << 10)|(((0x0UL) & 0x1fUL) << 5)));
    }
    else if(timer == ((TIMER_T *) (((0x40000000UL) + 0x00040000UL) + 0x11000UL)))
    {
        u32Src = CLK_GetModuleClockSource(((((1UL) & 0x03UL) << 30)|((((uint32_t)(4)) & 0x1fUL) << 0) | (((1UL) & 0x03UL) << 28)|(((7UL) & 0x07UL) << 25)|(((16UL) & 0x1fUL) << 20)| (((0x0UL) & 0x03UL) << 18)|(((0x0UL) & 0xffUL) << 10)|(((0x0UL) & 0x1fUL) << 5)));
    }
    else if(timer == ((TIMER_T *) ((((0x40000000UL) + 0x00040000UL) + 0x11000UL) + 0x100UL)))
    {
        u32Src = CLK_GetModuleClockSource(((((1UL) & 0x03UL) << 30)|((((uint32_t)(5)) & 0x1fUL) << 0) | (((1UL) & 0x03UL) << 28)|(((7UL) & 0x07UL) << 25)|(((20UL) & 0x1fUL) << 20)| (((0x0UL) & 0x03UL) << 18)|(((0x0UL) & 0xffUL) << 10)|(((0x0UL) & 0x1fUL) << 5)));
    }
    else
    {
        u32Clk = 0UL;
    ...
    else
    {
        if(u32Src == 2UL)
        {
            if((timer == ((TIMER_T *) (((0x40000000UL) + 0x00040000UL) + 0x10000UL))) || (timer == ((TIMER_T *) ((((0x40000000UL) + 0x00040000UL) + 0x10000UL) + 0x100UL))))
            {
...
# 331 "../../CCC_common/Library/StdDriver/src/timer.c"
                             ...
                             uint32_t u32EnableInt)
{
    ...
    if(timer == ((TIMER_T *) (((0x40000000UL) + 0x00040000UL) + 0x10000UL)))
    {
        t = ((TIMER_T *) ((((0x40000000UL) + 0x00040000UL) + 0x10000UL) + 0x100UL));
    }
    else if(timer == ((TIMER_T *) (((0x40000000UL) + 0x00040000UL) + 0x11000UL)))
    {
        t = ((TIMER_T *) ((((0x40000000UL) + 0x00040000UL) + 0x11000UL) + 0x100UL));
    }
    else
    {
        t = 0UL ;
...
# 368 "../../CCC_common/Library/StdDriver/src/timer.c"
void TIMER_DisableFreqCounter(TIMER_T *timer)
{
    timer->CTL &= ~(0x1ul << (19));
}
# 385 "../../CCC_common/Library/StdDriver/src/timer.c"
void TIMER_SetTriggerSource(TIMER_T *timer, uint32_t u32Src)
{
    timer->TRGCTL = (timer->TRGCTL & ~(0x1ul << (0))) | u32Src;
}
# 404 "../../CCC_common/Library/StdDriver/src/timer.c"
void TIMER_SetTriggerTarget(TIMER_T *timer, uint32_t u32Mask)
{
    timer->TRGCTL = (timer->TRGCTL & ~((0x1ul << (1)) | (0x1ul << (3)) | (0x1ul << (2)) | (0x1ul << (4)))) | u32Mask;
}
# 419 "../../CCC_common/Library/StdDriver/src/timer.c"
int32_t TIMER_ResetCounter(TIMER_T *timer)
{
    uint32_t u32Delay;
