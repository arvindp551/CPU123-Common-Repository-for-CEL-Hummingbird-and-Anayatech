# 1 "source/interlock.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 402 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "source/interlock.c" 2
# 17 "source/interlock.c"
...
# 93 "source/interlock.c"
void interlock(void) {
  vo_struct_t* vo = &vo_u.x;
  nvo_struct_t* nvo = &nvo_u.x;

  if(ctrls_u.x.interlock_mode == 0x03U) {
    interlock_DL();
    interlock_TGT_SM_DL();
    interlock_TCF_SM_DL();
  ...
  else if(ctrls_u.x.interlock_mode == 0x01U) {
    interlock_SL();
    interlock_TGT_SM();
    interlock_TCF_SM();
    interlock_Buzzer_SM();
  }
  else if(ctrls_u.x.interlock_mode == 0x02U) {
    interlock_Bypass();
  }
  else {
  ...
  else if(((TGTR_2 == 2U) || (TGTR_3 == 2U)) && (g_120s_ticks == 0U)) {
    vo_u.x.TGTR = 1U;
    vo_u.x.TGTR_D = 2U;
  }
  else {
  ...
  else if(((TCFR_2 == 2U) || (TCFR_3 == 2U)) && (g_120s_ticks == 0U)) {
    vo_u.x.TCFR = 1U;
    vo_u.x.TCFR_D = 2U;
  }
  else {
