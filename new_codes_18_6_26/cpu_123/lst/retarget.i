# 1 "../../CCC_common/Library/StdDriver/src/retarget.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 402 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../CCC_common/Library/StdDriver/src/retarget.c" 2
# 14 "../../CCC_common/Library/StdDriver/src/retarget.c"
...
# 15 "../../CCC_common/Library/StdDriver/src/retarget.c" 2
...
# 16 "../../CCC_common/Library/StdDriver/src/retarget.c" 2
# 46 "../../CCC_common/Library/StdDriver/src/retarget.c"
FILE __stdout;
FILE __stdin;
...
# 185 "../../CCC_common/Library/StdDriver/src/retarget.c"
...
# 225 "../../CCC_common/Library/StdDriver/src/retarget.c"
    printf("  HardFault!\n\n");
...
# 262 "../../CCC_common/Library/StdDriver/src/retarget.c"
void SendChar_ToUART(int ch)
{
...
# 339 "../../CCC_common/Library/StdDriver/src/retarget.c"
void SendChar(int ch)
{
# 370 "../../CCC_common/Library/StdDriver/src/retarget.c"
    SendChar_ToUART(ch);

}
# 383 "../../CCC_common/Library/StdDriver/src/retarget.c"
char GetChar(void)
{
# 421 "../../CCC_common/Library/StdDriver/src/retarget.c"
    while(1)
    {
...
# 443 "../../CCC_common/Library/StdDriver/src/retarget.c"
int kbhit(void)
{
    return !((((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->FIFOSTS & (0x1ul << (14))) == 0U);
}
# 458 "../../CCC_common/Library/StdDriver/src/retarget.c"
int IsDebugFifoEmpty(void)
{
    return ((((UART_T *) (((0x40000000UL) + 0x00040000UL) + 0x30000UL))->FIFOSTS & (0x1ul << (28))) != 0U);
}
# 473 "../../CCC_common/Library/StdDriver/src/retarget.c"
void _ttywrch(int ch)
{
    SendChar(ch);
    return;
}
# 498 "../../CCC_common/Library/StdDriver/src/retarget.c"
int fputc(int ch, FILE *stream)
{
    SendChar(ch);
    return ch;
}
# 548 "../../CCC_common/Library/StdDriver/src/retarget.c"
int fgetc(FILE *stream)
{
    return ((int)GetChar());
}
# 568 "../../CCC_common/Library/StdDriver/src/retarget.c"
int ferror(FILE *stream)
{
    return (-1);
}
