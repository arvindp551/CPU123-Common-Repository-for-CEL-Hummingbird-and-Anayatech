# 1 "source/driver/drvr_spi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 402 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "source/driver/drvr_spi.c" 2
...
# 5 "source/driver/include\\drvr_spi.h" 2
...
void spi_ctor(spi_struct_t* handle) {
 ...
 switch (handle->port) {
 case 2:
  SPIx = ((SPI_T *) (((0x40000000UL) + 0x00040000UL) + 0x23000UL));


     CLK_SetModuleClock(((((1UL) & 0x03UL) << 30)|((((uint32_t)(15)) & 0x1fUL) << 0) | (((2UL) & 0x03UL) << 28)|(((3UL) & 0x07UL) << 25)|(((10UL) & 0x1fUL) << 20)| (((0x0UL) & 0x03UL) << 18)|(((0x0UL) & 0xffUL) << 10)|(((0x0UL) & 0x1fUL) << 5)), (0x2UL<<(10)), 0x0UL);

     CLK_EnableModuleClock(((((1UL) & 0x03UL) << 30)|((((uint32_t)(15)) & 0x1fUL) << 0) | (((2UL) & 0x03UL) << 28)|(((3UL) & 0x07UL) << 25)|(((10UL) & 0x1fUL) << 20)| (((0x0UL) & 0x03UL) << 18)|(((0x0UL) & 0xffUL) << 10)|(((0x0UL) & 0x1fUL) << 5)));





     ((SYS_T *) ((0x40000000UL) + 0x00000UL))->GPA_MFPH &= ~((0xful << (28)) | (0xful << (24)) | (0xful << (20)) | (0xful << (16)));
     ((SYS_T *) ((0x40000000UL) + 0x00000UL))->GPA_MFPH |= ((0x05UL<<(28)) | (0x05UL<<(24)) | (0x05UL<<(20)) | (0x05UL<<(16)));

     ((GPIO_T *) ((0x40000000UL) + 0x04000UL))->SMTEN |= (0x1ul << (13));

  if(handle->is_master == 1U) {

   GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04080UL)), 0x00000020UL, 0x1UL);
   (*((volatile uint32_t *)((((0x40000000UL) + 0x04800UL)+(0x40*(2))) + ((5)<<2)))) = 1;
  }
  SPIx_IRQn = SPI2_IRQn;
  break;
 case 1:
  SPIx = ((SPI_T *) (((0x40000000UL) + 0x00040000UL) + 0x22000UL));
     ...
     ((SYS_T *) ((0x40000000UL) + 0x00000UL))->GPA_MFPL &= ~((0xful << (28)) | (0xful << (24)));
     ((SYS_T *) ((0x40000000UL) + 0x00000UL))->GPA_MFPL |= ((0x04UL<<(28)) | (0x04UL<<(24)));
     ((SYS_T *) ((0x40000000UL) + 0x00000UL))->GPC_MFPL &= ~((0xful << (28)) | (0xful << (24)));
     ((SYS_T *) ((0x40000000UL) + 0x00000UL))->GPC_MFPL |= ((0x04UL<<(28)) | (0x04UL<<(24)));

     ((GPIO_T *) ((0x40000000UL) + 0x04000UL))->SMTEN |= (0x1ul << (7));

  if(handle->is_master == 1U) {
   GPIO_SetMode(((GPIO_T *) ((0x40000000UL) + 0x04080UL)), 0x00000010UL, 0x1UL);
   (*((volatile uint32_t *)((((0x40000000UL) + 0x04800UL)+(0x40*(2))) + ((4)<<2)))) = 1;
  }
  SPIx_IRQn = SPI1_IRQn;
  break;
 default:
 ...
 if(handle->inten == 1U) {
     __NVIC_EnableIRQ(SPIx_IRQn);
 }
 else {
     __NVIC_DisableIRQ(SPIx_IRQn);
 }
 ...
 if(SPIx != 0) {
  ...
  if(handle->is_master == 1U) {
   SPI_Open(SPIx, (0x0UL), ((0x1ul << (2))), 8, 12000000);

   SPI_DisableAutoSS(SPIx);
  }
  else {
   SPI_Open(SPIx, ((0x1ul << (18))), ((0x1ul << (2))), 8, 12000000);
  }
...
void spi_agent_sm(spi_struct_t* handle) {
 ...
 switch (handle->state) {
  ...
  case SPI_READ_FIFO:
   while(( ((SPIx)->STATUS & (0x1ul << (8))) >> (8) ) == 0U) {
    ch = ( (handle->SPIx)->RX );
    fifo_write(handle->prx,ch);
   }
   if((SPIx->STATUS & (0x1ul << (3))) != 0U) {

    SPIx->STATUS |= (0x1ul << (3));

    handle->cb();

    SPIx->FIFOCTL |= ((0x1ul << (8)) | (0x1ul << (9)));
  ...
  case SPI_WRITE_FIFO:
   ...
   while(handle->ptx->is_empty == 0U) {
    if(( ((handle->SPIx)->STATUS & (0x1ul << (17))) >> (17) ) == 0U) {
