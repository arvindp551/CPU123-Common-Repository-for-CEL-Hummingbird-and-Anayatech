 ...
 * @param addr_start	Flash starting address
 * @param addr_end		Flash ending address
...
/**
 * @brief For update the configuration of Flash erase the page and program the flash
 */
